...
function data_util.remove_number_suffix(str)
  ...
  if data_util.string_to_simple_int(parts[#parts]).."" == parts[#parts] then
  ...
  if data.raw[prototype.type] and data.raw[prototype.type][prototype.name] then
    ...
    if not raw.normal then
      raw.normal = {
        ...
        unlock_results = raw.unlock_results,
      ...
      raw.emissions_multiplier = nil
      raw.overload_multiplier = nil
      raw.allow_inserter_overload = nil
      raw.hide_from_stats = nil
      raw.hide_from_player_crafting = nil
      raw.allow_decomposition = nil
      raw.allow_as_intermediate = nil
      raw.allow_intermediates = nil
      raw.always_show_made_in = nil
      raw.show_amount_in_title = nil
      raw.always_show_products = nil
      raw.unlock_results = nil
      raw.main_product = nil
    end
...
function data_util.techs_add_ingredients(prototype_names, ingredients, cascade, allow_multiple_specialist)
  for _, prototype_name in pairs(prototype_names) do
    data_util.tech_add_ingredients (prototype_name, ingredients, cascade, allow_multiple_specialist)
  end
end
...
function data_util.tech_add_ingredients(prototype_name, ingredients, cascade, allow_multiple_specialist, allow_multiple_deep)
  -- log("tech_add_ingredients: " .. prototype_name .. ", added " .. serpent.line(ingredients))
  local prototype = data.raw.technology[prototype_name]
  if not prototype then return end
  local added = false
...
function data_util.techs_add_ingredients_with_prerequisites (prototype_names, ingredients)
  for _, prototype_name in pairs(prototype_names) do
    data_util.tech_add_ingredients_with_prerequisites (prototype_name, ingredients)
  end
end
-- cascade applies to children too
