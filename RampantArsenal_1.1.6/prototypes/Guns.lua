...
function guns.enable()
    ...
    if settings.startup["rampant-arsenal-enableAmmoTypes"].value then
        ...
        data.raw["ammo"]["shotgun-shell"]["ammo_type"]["action"][2]["action_delivery"]["max_range"] = 40

        data.raw["ammo"]["piercing-shotgun-shell"]["ammo_type"]["action"][2]["action_delivery"]["max_range"] = 40

        data.raw["gun"]["shotgun"]["attack_parameters"]["range"] = 40

        data.raw["gun"]["combat-shotgun"]["attack_parameters"]["range"] = 40
