...
--Entity
  {
	...
	--equipment_grid = "kj_747",
	--render_layer = "higher-object-under",
	minimap_representation = {
		filename = "__kj_747__/graphics/plane_icon.png",
		flags = {"icon"},
		size = {128, 128},
		scale = 0.3,
	},
    ...
    animation =
    {
      layers =
      {
		layermaker("747_wheels", 2000, 3, 3, 1, 4, 32, false, false, 2),
		layermaker("747_corpus", 2000, 3, 3, 1, 4, 32, false, false, 2),
		layermaker("747_rotor" , 2000, 3, 1, 3, 4, 32, false, false, 2),
		
		layermaker("747_wheels", 2000, 3, 3, 1, 4, 32, true, false, 2),
		layermaker("747_corpus", 2000, 3, 3, 1, 4, 32, true, false, 2),
	  },
    },
    ...
    working_sound =
    {
      sound =
      {
        filename = "__kj_747__/sounds/motor.ogg",
        volume = 0.6
      },
      activate_sound =
      {
        filename = "__kj_747__/sounds/motor_start.ogg",
        volume = 0.6
      },
      deactivate_sound =
      {
        filename = "__kj_747__/sounds/motor_stop.ogg",
        volume = 0.6
      },
    ...
    {
      {
        filename = "__kj_747__/sounds/motor_failure.ogg",
        volume = 0.6
      }
    },
    open_sound = { filename = "__kj_747__/sounds/mouse_door_open.ogg", volume = 0.7 },
    close_sound = { filename = "__kj_747__/sounds/mouse_door_close.ogg", volume = 0.7 },
