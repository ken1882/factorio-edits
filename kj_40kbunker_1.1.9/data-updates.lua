	...
	data:extend({
		{
			...
			icon = "__kj_40kbunker__/graphics/compatibility_icon.png",
			icon_size = 128,
			stack_size = 1
		},	
	})
...
if mods["kj_rattetank"] or mods["kj_utilitarian"] or mods["kj_king_jos_vehicles"] or mods["kj_aventador"] or mods["kj_maustank"] or boolean then
	...
	data.raw["item-subgroup"]["kj_40kbunker"].group = "kj_vehicles"
	data.raw["item-subgroup"]["kj_40kbunker"].order = "w-0[buildings]-bunker"
end
