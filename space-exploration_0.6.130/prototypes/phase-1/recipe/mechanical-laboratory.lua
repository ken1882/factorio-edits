...
make_recipe({
  ...
  ingredients = {
    { name = "firearm-magazine", amount = 8},
    { name = data_util.mod_prefix .. "material-testing-pack", amount = 1},
    { name = data_util.mod_prefix .. "heavy-girder", amount = 1},
    { name = data_util.mod_prefix .. "iridium-plate", amount = 1},
  ...
  results = {
    { name = data_util.mod_prefix .. "ballistic-shielding-data", amount = 2},
...
make_recipe({
  ...
  results = {
    { name = data_util.mod_prefix .. "decompression-resistance-data", amount_min = 10, amount_max = 10, probability = 0.75},
    { name = data_util.mod_prefix .. "junk-data", amount_min = 10, amount_max = 10, probability = 0.24},
    { name = data_util.mod_prefix .. "significant-specimen", amount_min = 1, amount_max = 1, probability = 0.75},
