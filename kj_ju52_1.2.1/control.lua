...
function on_configuration_changed(ConfigurationChangedData)
	...
	if ConfigurationChangedData.mod_changes[ModName] ~= nil then
		...
		if Old ~= nil and New ~= nil then
			if Old <= '1.1.3' and New >= '1.1.4' then
				game.print('[font=heading-1][color=#FF2D00]Ju-52 Mod Update Information![/color][/font]')
				game.print('Version: 1.1.4')
