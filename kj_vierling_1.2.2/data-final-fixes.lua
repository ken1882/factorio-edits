...
if mods["kj_rattetank"] or mods["kj_utilitarian"] or mods["kj_king_jos_vehicles"] or mods["kj_aventador"] or mods["kj_maustank"] or boolean then
	...
	{	
		{
			type = "item-group",
			name = "kj_vehicles",
			icon = "__kj_vierling__/graphics/thumbnail_categories.png",
			icon_size = 560,
			inventory_order = "x",
			order = "kj_vehicles"
		},
	...
	data.raw["item-subgroup"]["kj_vierling"].group = "kj_vehicles"
	data.raw["item-subgroup"]["kj_vierling"].order = "w-1[buildings]-flak"
	data.raw["ammo"]["kj_2cmfv_normal_vierling"].subgroup = "kj_vierling"
end
