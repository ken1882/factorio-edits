...
data:extend({
...

	{
		...
		icon = "__kj_rattetank__/graphics/equipment/ap_cannon_shell2.png",
		icon_size = 64,
		ammo_type =
		{
		  category = "kj_280SKC34",
		...
		subgroup = "ammo",
		order = "r[rattetank]-a[penetration]",
		stack_size = 50
	},
	{
		type = "ammo",
		name = "kj_280SKC34_highexplosive",
		icon = "__kj_rattetank__/graphics/equipment/he_cannon_shell2.png",
		icon_size = 64,
		ammo_type =
		{
		  category = "kj_280SKC34",
		...
		subgroup = "ammo",
		order = "r[rattetank]-b[highexplosive]",
		stack_size = 50
	},
	{
		type = "ammo",
		...
		subgroup = "ammo",
		order = "r[rattetank]-c[incendiary]",
		stack_size = 50
	},

	{
		...
		animation =
		{
		  filename = "__kj_rattetank__/graphics/ratte_projectile.png",
		  frame_count = 1,
		  width = 151,
		  height = 156,
		  priority = "high"
