...
data:extend({
	{
		type = "ammo",
		name = "kj_xb35_medium",
		icon = "__kj_xb35__/graphics/equipment/bomb_250.png",
		icon_size = 128,
		ammo_type =
		{
		  category = "kj_plane_xb35",
		  ...
		  action =
		  {
			...
			action_delivery =
			{
			  ...
			  --[[source_effects =
			  {
				...
				entity_name = "kj_xb35_shot"
			  }]]
			}
		  }
		},
		subgroup = "ammo",
		order = "xb35[xb35]-b[medium]",
		stack_size = 80,
		magazine_size = 1,
		reload_time = 20,
	},
...

	{
		type = "ammo",
		name = "kj_xb35_big",
		icon = "__kj_xb35__/graphics/equipment/bomb_500.png",
		icon_size = 128,
		ammo_type =
		{
		  category = "kj_plane_xb35",
...

	{
		type = "ammo",
		name = "kj_xb35_huge",
		icon = "__kj_xb35__/graphics/equipment/bomb_1000.png",
		icon_size = 128,
		ammo_type =
		{
		  category = "kj_plane_xb35",
...

	{
		type = "ammo",
		name = "kj_xb35_atom",
		icon = "__kj_xb35__/graphics/equipment/bomb_atomic.png",
		icon_size = 128,
		ammo_type =
		{
		  category = "kj_plane_xb35",
