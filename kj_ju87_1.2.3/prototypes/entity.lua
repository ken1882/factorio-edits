...
--Entity
  {
	...
	--equipment_grid = "kj_ju87",
	--render_layer = "higher-object-under",
	minimap_representation = {
		filename = "__kj_ju87__/graphics/plane_icon_small.png",
		flags = {"icon"},
		size = {128, 128},
		scale = 0.3,
	},
	...
	consumption = "600kW",
    terrain_friction_modifier = 0.02,
    friction = 0.001,
    light = entityLight,
    animation =
    {
      layers =
      {
		layermaker("ju87_corpus", 360, 3, 3, 1, 8, 16, false, false),
		layermaker("ju87_rotor" , 360, 3, 1, 3, 8, 16, false, false),
		layermaker("ju87_corpus", 360, 3, 3, 1, 8, 16, true, false),
		layermaker("ju87_rotor" , 360, 3, 1, 3, 8, 16, true, false),
      }
    },
    ...
    working_sound =
    {
      sound =
      {
        filename = "__kj_ju87__/sounds/motor.ogg",
        volume = 0.6
      },
      activate_sound =
      {
        filename = "__kj_ju87__/sounds/motor_start.ogg",
        volume = 0.6
      },
      deactivate_sound =
      {
        filename = "__kj_ju87__/sounds/motor_stop.ogg",
        volume = 0.6
      },
    ...
    {
      {
        filename = "__kj_ju87__/sounds/motor_failure.ogg",
        volume = 0.6
      }
    },
