...
adv_card.ingredients = {
  {name = "se-significant-data", amount = 1}, -- 1 data card
  {name = "se-kr-advanced-catalogue-1", amount = 1}, -- 11 data card
...
sing_pack.ingredients = {
  ...
  {"se-significant-data", 1}, -- 1 data card
  {"se-kr-advanced-catalogue-2", 1}, -- 11 data cards
  {"ai-core", 5},
