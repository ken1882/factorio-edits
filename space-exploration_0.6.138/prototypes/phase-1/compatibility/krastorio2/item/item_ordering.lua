...
data.raw.item["fuel-processor"].order = "f[fuel-processing]-a[fuel-processor]"
data.raw.item["kr-fuel-refinery"].subgroup = "chemistry"
data.raw.item["kr-fuel-refinery"].order = "f[fuel-processing]-b[kr-fuel-refinery]"
data.raw.item["se-fuel-refinery"].subgroup = "chemistry"
data.raw.item["se-fuel-refinery"].order = "f[fuel-processing]-c[se-fuel-refinery]"

-- Mechanical
data.raw.item["kr-crusher"].subgroup = "mechanical"
data.raw.item["kr-crusher"].order = "z-d-y"
