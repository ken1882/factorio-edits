...
se_core_fragment_resources["raw-rare-metals"] = { multiplier = 1, omni_multiplier = 0.25}
se_core_fragment_resources["raw-imersite"] = { multiplier = 1.25, omni_multiplier = 0}
se_core_fragment_resources["mineral-water"] = { multiplier = 0.25, omni_multiplier = 0.05}
