...
{
  {
    ...
    variants =
    {
      ...
      {
        {
          ...
          size = 1,
          hr_version = {
            picture = "__space-exploration-graphics__/graphics/terrain/spaceship-floor/hr-tile1.png",
            size = 1,
            scale = 0.5
          }
        }
      ...
      inner_corner =
      {
        ...
        count = 1,
        hr_version = {
          picture = "__space-exploration-graphics__/graphics/terrain/spaceship-floor/hr-tile-inner-corner.png",
          scale = 0.5
        }
      },
      outer_corner =
      {
        ...
        count = 1,
        hr_version = {
          picture = "__space-exploration-graphics__/graphics/terrain/spaceship-floor/hr-tile-outer-corner.png",
          scale = 0.5
        }
      },
      side =
      {
        ...
        count = 16,
        hr_version = {
          picture = "__space-exploration-graphics__/graphics/terrain/spaceship-floor/hr-tile-side.png",
          scale = 0.5
        }
      },
      u_transition =
      {
        ...
        count = 1,
        hr_version = {
          picture = "__space-exploration-graphics__/graphics/terrain/spaceship-floor/hr-tile-u.png",
          scale = 0.5
        }
      },
      o_transition =
      {
        ...
        count = 1,
        hr_version = {
          picture = "__space-exploration-graphics__/graphics/terrain/spaceship-floor/hr-tile-o.png",
          scale = 0.5
        }
      }
    },
