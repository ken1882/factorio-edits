...
function DeliveryCannon.attempt_fire(delivery_cannon)
  ...
  if delivery_cannon.force_name then
    ...
    force.item_production_statistics.on_flow(delivery_cannon.payload_name, -1)
  end
...
local function on_post_entity_died(event)
  ...
  ghost.tags = DeliveryCannon.serialize_from_struct(global.delivery_cannons[unit_number])
  global.delivery_cannons[unit_number] = nil
end
